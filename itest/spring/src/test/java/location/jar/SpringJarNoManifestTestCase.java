 ...
 * @version $Rev$ $Date$
 */
public class SpringJarNoManifestTestCase extends AbstractHelloWorldTestCase {
    // super class does it all getting composite based on this class name
	
	public SpringJarNoManifestTestCase() {
        super("SpringJarNoManifest.composite", "location/jar");        
    }
}
