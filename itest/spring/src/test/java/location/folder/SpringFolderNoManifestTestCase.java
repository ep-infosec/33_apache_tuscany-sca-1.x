 ...
 * @version $Rev$ $Date$
 */
public class SpringFolderNoManifestTestCase extends AbstractHelloWorldTestCase {
    // super class does it all getting composite based on this class name
	
	public SpringFolderNoManifestTestCase() {
        super("SpringFolderNoManifest.composite", "location/folder");        
    }
}
